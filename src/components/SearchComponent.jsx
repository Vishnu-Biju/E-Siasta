    ...
    <div className="relative">
      <div className="flex items-center">
        <input
          ...
          placeholder="Search for products"
          className="w-full md:w-66 h-10 pl-4 pr-12 rounded-full border-2 border-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-500"
        />
      ...
      {loading ? (
        <div className="absolute bg-white w-full md:w-66 max-h-60vh mt-2 p-2 shadow-md rounded-md overflow-y-auto border-2 border-pink-500">
          <div className="animate-pulse h-10 bg-gray-300 rounded my-1"></div>
          <div className="animate-pulse h-10 bg-gray-300 rounded my-1"></div>
          <div className="animate-pulse h-10 bg-gray-300 rounded my-1"></div>
        </div>
